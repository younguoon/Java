...
//
//import sungJuk.jdbc.gui.DrawingPanel;
//import sungJuk.jdbc.gui.Sungjuk;
//
//public class EventActionListener_else implements ActionListener {
//	JTable table;
//	JTextField txHakbun, txIrum, txKor, txEng, txMath, txTot, txAvg, txGrade;
//	DrawingPanel drawingPanel;
//
//	EventActionListener_else() {
//	}
//
//	EventActionListener_else(JTable table) {
//		this.table = table;
//	}
//
//	public EventActionListener_else(JTable table, DrawingPanel drawingPanel) {
//		this.table = table;
//		this.drawingPanel = drawingPanel;
//	}
//
//	public EventActionListener_else(JTable table, JTextField txHakbun, JTextField txIrum, JTextField txKor,
